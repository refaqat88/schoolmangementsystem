...
<div class="col-md-12 card" id='fee_slip'>
    <form id="RegisterValidation" action="#" method="">
        <div class="container-fluid p-5" >
            <div class="row stdFeeSlip">
                <div class="col-12">
                    <button class="pull-right btn btn-secondary btn-round btn-sm" onclick="printThis('stdFeeSlip','')"><i class="fa fa-print"></i></button>
                </div>
                    ...
                    <div class="card card_size" style='border:1px solid black;'>
                        <div class="card-header">
                            <div class="col-md-12 text-center lh-1 mb-2">
                                <h6 class="fw-bold">Fee Slip</h6> <span class="fw-normal">Fee slip for the month of
                                    <span id='date' class="font-weight-bold">{{
                                        substr($Months[$data['month']],0,3)}}</span></span>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-50">
                                                    <p class="">@php
                                                        ...
                                                        $admission_number =
                                                        $data['student']->studentinfo->admission->adm_Number;
                                                        }
                                                        }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="">{{$data['class']->class}} @php
                                                        ...
                                                        $section =
                                                        '('.$data['student']->studentinfo->section->class_section_name.')';
                                                        }
                                                        }
                                                        echo $section;
                                ...
                                <div class="col-sm-4  col-lg-4  justify-content-end" style="font-size:80%">
                                    ...
                                    <table class="  table-full-width">
                                        ...
                                        <tbody class="w-100">
                                            ...
                                            <tr>
                                                <td>{{ date("Y/m/d",strtotime($data['Fee_schedule']['issue_date']))}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Due Date</th>
                                ...
                                <table class="table table-bordered" style="line-height: 5px!important;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">&#8360; {{
                                                number_format($data['Fee_schedule']['payable_by_due_date'])}}</td>

                                        </tr>
                                        <tr>
                                            <th>Payable after due date</th>
                                            <td class="text-right"> &#8360; {{
                                                number_format($data['Fee_schedule']['payable_after_due_date'])}} </td>
                            ...
                            <div class=" card-footer">
                                <h6 class="text-left font-weight-light ">Address: <span class='font-weight-bold'>
                                        {{$data['school']->domicile?$data['school']->domicile->dom_District:''}}
                                        {{$data['school']->city?$data['school']->city->city_name:''}}
                                        {{$data['school']->school_Add?$data['school']->school_Add:''}} </span></h6>

                                <h6 class="text-left font-weight-light">Note: <span class='font-weight-bold'> This
                                        Challan
                                        Form
