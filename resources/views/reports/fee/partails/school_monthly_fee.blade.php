   ...
   <form id="RegisterValidation" action="#" method="">
     <div class="card">
       ...
       <div class="container-fluid m-4">
            <div class="row d-flex flex-row align-items-center">
                ...
                <div class="col-md-2 d-flex flex-row">
                    <button class="pull-right btn btn-secondary btn-round btn-sm" onclick="printThis('printMonthlyFeeReport','<h3>Student Monthly Fee Reports</h3>')"><i class="fa fa-print"></i></button>
                </div>
            </div>
       </div>
       ...
       <div class="card-body">
         ...
         <table id="paystatementdatatable" data-id="paystatementdatatable" class="table custom_border table-hover printMonthlyFeeReport" cellspacing="0"
           width="100%">
           <thead>
             <tr class="">
