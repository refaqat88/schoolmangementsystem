<div class="modal fade nopadd" id="emptatement" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-full modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body row">
        <div class="col-md-12">
          <form id="Formemptatements" action="#" method="">
              ...
              <div class="row bor-sep">
                <div class="col-sm-9">
                    ...
                    <div class="row applyTransarow ">
                        <button type="button" data-id="" id="applybtn" class="btn mt-3 mb-3 btn-round  btn-secondary  empstatement"> Apply</button>
                    </div>
                      ...
                      <div class="toolbar">
                        <div class="row">
                          <div class="col-sm-12 float-right">
                           ...
                           <button class=" pay-statemnt-trans-btn btn mb-3 btn-outline-choice btn-round col-sm-12 col-lg-3 btn-sm pull-left"  aria-expanded="false">
...
{{-- modal for print pay statement --}}

<div class="modal fade nopadd" id="print-paystatement" tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
    aria-hidden="true">
    <div class="modal-full modal-dialog">
        <div class="modal-content">
            <div class="modal-header justify-content-center">
                ...
                <button class="pull-right btn btn-secondary btn-round btn-sm" id="print-pay-state"><i class="fa fa-print"></i></button>
                <h5 class="title title-up">Print Statements</h5>
            </div>
            <div class="modal-body row print_pay_statement">
