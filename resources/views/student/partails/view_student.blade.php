...
<div class="container-fluid">
    <div class="col-md-12 mb-2">
        ...
        <h5 class='text-center' Class="school-add"> District <span class="sch-district">{{$school->domicile->dom_District}}</span></h5>
    </div>
    ...
    <div class="row mt-5">
        ...
        <div class="row bor-sep">
            ...
            <div class="col-md-4 flex-row d-inline-flex ">
                <p><b>Form B:</b> </p>
                <p class="col-md-3 border-bottom" id="std-name"> {{ $student->username}} </p>
            </div>
            ...
            <div class="col-md-2 flex-row d-inline-flex">
                <p><b>Age:</b> </p>
                <p class="col-md-8 border-bottom"> {{$student->studentinfo?$student->studentinfo->age():''}} (years) </p>
            </div>
            <div class="col-md-3 flex-row d-inline-flex">
                <p><b>Blood Group:</b> </p>
                <p class="col-md-6 border-bottom" id="std-bldgroup">{{$student->studentinfo?$student->studentinfo->blood->blood_group:'' }} </p>
            </div>
            <div class="col-md-3 flex-row d-inline-flex">
                <p><b>Religion:</b> </p>
                <p class="col-md-6 border-bottom" id="std-religion">{{$student->studentinfo->religion->religion }} </p>
            </div>
            <div class="col-md-3 flex-row d-inline-flex">
                <p><b>Nationality:</b> </p>
            ...
            <div class="col-md-12">
                <label for="" class='font-weight-bold mx-2'>Address: </label> <span class='font-weight-normal col-md-12 border-bottom' id="std-address">{{$student->studentinfo?$student->studentinfo->contact->pnt_mail_Add:''}}</span> </div>
        </div>
    </div>
    <div class="row mt-5">
        <div class="col-md-12 text-left">
            <h6>Father INFORMATION</h6> </div>
        <div class="row bor-sep">
            <div class="col-md-4 flex-row d-inline-flex">
                ...
                if($mother){
                   ...
                   if($mother->guardianInfo){
                      ...
                      if($mother->guardianInfo){
                          ...
                          $maritalStatus = $mother->guardianInfo?$mother->guardianInfo->pnt_marital_Status:'';
    ...
    <div class="row mt-5 ">
        ...
        <div class="bor-sep row w-100">
            ...
            <div class="col-md-4 flex-row d-inline-flex">
                <p><b>Date of Leaving:</b> </p>
                <p class="col-md-6 border-bottom" id="std-lastschool-dateofleave">{{date("d-m-Y",  strtotime($lastSchool->lsch_lv_Date))}} </p>
            </div>
            <div class="col-md-4 flex-row d-inline-flex">
                <p><b>Class Passed:</b> </p>
                <p class="col-md-6 border-bottom" id="std-class-passed"> {{$lastSchool->class?$lastSchool->class->class:''}}</p>
            </div>
        </div>
    </div>
     @endif
    ...
    <div class="row mt-5 mr-2">
        ...
        <div class="row bor-sep col-md-12">
            <div class="col-md-4 flex-row d-inline-flex ">
                <p><b>Mobile Phone No:</b> </p>
                <p class="col-md-4 border-bottom"> {{ $student->studentInfo ? $student->studentInfo->contact->pnt_mob_Ph : ''}} </p>
            </div>
            <div class="col-md-4 flex-row d-inline-flex ">
                <p><b>Home Phone No:</b> </p>
                <p class="col-md-4 border-bottom"> {{ $student->studentInfo ? $student->studentInfo->contact->pnt_home_Ph : ''}} </p>
            </div>
            <div class="col-md-4 flex-row d-inline-flex ">
                <p><b>Email Address:</b> </p>
                <p class="col-md-4 border-bottom"> {{ $student->studentInfo ? $student->studentInfo->contact->pnt_Email : ''}} </p>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5 mr-2">
        ...
        <div class="row bor-sep col-md-12">
            <div class="col-md-4 flex-row d-inline-flex ">
                ...
                <p class="col-md-4 border-bottom"> {{ $student->studentInfo ? $student->studentInfo->contact_emergency->emer_cont_Name : ''}} </p>
            </div>
            <div class="col-md-4 flex-row d-inline-flex ">
                <p><b>Contact Phone:</b> </p>
                <p class="col-md-4 border-bottom"> {{ $student->studentInfo ? $student->studentInfo->contact_emergency->emer_cont_No : ''}} </p>
            </div>
            <div class="col-md-4 flex-row d-inline-flex ">
                <p><b>Relation:</b> </p>
                <p class="col-md-4 border-bottom"> {{ $student->studentInfo ? $student->studentInfo->contact_emergency->relations->relation_Name : ''}} </p>
            </div>
        </div>
    </div>
    <div class="row mt-5">
        ...
        <div class="row bor-sep">
            ...
            <div class="col-md-6 flex-row d-inline-flex">
                ...
                <p class="col-md-8 border-bottom" id="adm-date">{{$student?$student->studentinfo->admission->adm_Date:''}}</p>
            </div>
            <div class="col-md-12">
