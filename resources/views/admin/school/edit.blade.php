                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" action="{{url('admin/school/update')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="school_logo" class="form-control @error ('school_logo') is-invalid @enderror" id="school-name" value="{{ $school->school_logo}}">
                                                    @error('school_logo')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label></label>
                                                    <p><img src="{{ asset('upload/school/'.$school->school_logo) }}" width="50px" height="50" alt="gfre">
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="school-name">Abbreviation</label>
                                                <input type="text" class="form-control @error('abbreviation') is-invalid @enderror" id="school-name" value="{{ $school->school_abbreviation}}" name="abbreviation" placeholder="Enter abbreviation"/>
                                                @error('abbreviation')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control @error('start_time') is-invalid @enderror" id="start-time" value="{{ $school->start_time}}" name="start_time" placeholder="Select school starting time"/>
                                                @error('start_time')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control @error('end_time') is-invalid @enderror" id="close-time" value="{{ $school->end_time}}" name="end_time" placeholder="Select school closing time"/>
                                                @error('end_time')
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
