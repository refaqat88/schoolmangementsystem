...
{{--                                </div>--}}
{{--                            @endif--}}
                            <form role="form" action="{{url('admin/general-grade/update')}}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="{{ $grade->id}}">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="grade">Grade Name</label>
                                        <input type="text" class="form-control @error('grade_name') is-invalid @enderror" id="grade" value="{{ $grade->name}}" name="grade_name" placeholder="Enter Board Name"/>
                                        @error('grade_name')
