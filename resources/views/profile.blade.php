    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-user">
                ...
                <h3>hello fakhar, this is profile page of teacher</h3>
                <div class="card-body">
                    <div class="author">
                        @if(Auth::user()->user_image)
                            <img class="avatar border-gray" src="{{asset('upload/user/'.Auth::user()->user_image)}}" alt="Image">
                        @else
                        ...
                        <p class="text-muted text-center">{{Auth::user()->userType->user_type_Name}}</p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b class="fa fa-mobile-phone pull-left ml-0"> Mobile</b> <a class="pull-right">{{Auth::user()->phone}}</a>
                            </li>
                            <li class="list-group-item">
                                <b class="fa fa-envelope-o pull-left  ml-0"> Email</b> <a class="pull-right">{{Auth::user()->email}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
