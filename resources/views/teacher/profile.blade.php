    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card card-user">
                ...
                <h2>hello fakhar, this is the profile page of teacher </h2>
                <div class="card-body">
                    <div class="author">
                        @if($user->user_image)
                            <img class="avatar border-gray" src="{{asset('upload/employee/'.$user->user_image)}}" alt="Image">
                        @else
                            <img class="avatar border-gray" src="{{url('adminassets/img/accountant.jpg')}}" alt="Default User">
                        @endif
                        <h3 class="profile-username text-center">{{ $user->emp_given_name }}</h3>

                        <p class="text-muted text-center">user</p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b class="fa fa-mobile-phone pull-left"> Mobile</b> <a class="pull-right">{{ $user->emp_mob_Ph }}</a>
                            </li>
                            <li class="list-group-item">
                                <b class="fa fa-envelope-o pull-left"> Email</b> <a class="pull-right">{{ $user->emp_Email }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="table-condensed">
                        <table class="table table-hover" width="100%">
                            ...
                            <tr>
                                ...
                                <td>{{ $user->emer_cont_Name}}</td>
                            </tr>
                            <tr>
                                <th>Emergency Contact No</th>
                                <td>{{ $user->emer_cont_No}}</td>
                            </tr>
                            <tr>
                                <th>Emergency Contact Relation</th>
                                <td>{{ $user->fk_emer_relat_Id}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card-body table-full-width table-hover">
                    <div class="table-condensed">
                        <table class="table table-hover" width="100%">
                            ...
                            <tr>
                                <th>Hire Date</th>
                                <td>{{$user->appt_Date}}</td>
                            </tr>
                            <tr>
                                <th>Adjustment Date</th>
                                <td>{{$user->adjust_Date}}</td>
                            </tr>
                            <tr>
                                <th>Employment Status</th>
                                <td>{{$user->empt_Status}}</td>
                            </tr>
                            <tr>
                                <th>Contract Type</th>
