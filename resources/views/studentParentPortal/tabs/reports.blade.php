            ...
            <div class="card">
                <div class=" card-body">
                    ...
                    <table class="table table-bordered table-striped  m-table m-table--border-metal m-table--head-bg-metal">
                        ...
                        <tr>
                            <th style="width: 5%;">#</th>
                            <th style="width: 5%;">Reports 1</th>
                            <th style="width: 5%;">Reports 2</th>
                            <th style="width: 5%;">Reports 3</th>
                            <th style="width: 5%;">Reports 4</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            ...
                            <td class="font text-center">
                                <div class="text-center">Report 1</div>
                            </td>
                            <td class="font text-center">
                                <div class="text-center">Report 1</div>
                            </td>
