                           ...
                           <form action="{{url('class/create')}}" method="Post">
                                ...
                                <div class="">
                                        ...
                                        <div class="col-sm-12">
                                              <div class="row">
                                                ...
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" id="add-class-name" placeholder="" name="class_name" value="{{old('class_name')}}">
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="add-numeric-name">Numeric Name</label>
                                                    <input type="text" id="add-numeric-name" class="form-control" placeholder="" name="numeric_name" number="true" number="true"  value="{{old('numeric_name')}}">
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="add-no-of-period">No of Periods</label>
                                                    <input type="text" id="add-no-of-period" class="form-control" placeholder="" name="no_of_period"  number="true" number="true" value="{{old('no_of_period')}}">
                                                </div>
                                                ...
                                                <div class=" col-sm-6 select-wizard">
                                                    ...
                                                    <select class="form-control js-example-basic-single" id="school-section" name="school_section"  data-style="btn btn-secondary" title="Select Teacher" >
                                                        ...
                                                        <option value="{{$school_section->sc_sec_Id}}" {{ (collect(old('school_section'))->contains($school_section->sc_sec_Id)) ? 'selected':'' }}>{{$school_section->sc_sec_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label for="add-tuition-fee">Tuition Fee</label>
                                                    <input type="text" id="add-tuition-fee" class="form-control" placeholder="" name="tuition_fee" value="{{old('tuition_fee')}}">
                                                </div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <select class="" id="add-subject" name="subject[]" data-style="btn btn-secondary" multiple="multiple" title="Choose Subjects" data-size="10">
                                                       ...
                                                       @foreach($subjects as $subject))
                                                        <option value="{{$subject->sub_Id}}" {{ (collect(old('subject'))->contains($subject->sub_Id)) ? 'selected':'' }}>{{$subject->subject}} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="">
                                            <button type="submit" class="btn btn-outline-success btn-round" id="Save-Btn">Save</button>
                                        </div>
                                        <div class="divider"></div>
                                        <div class="">
